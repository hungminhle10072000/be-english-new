...
public class VocabularyTopicController {
    ...
    /*Get new topic vocabulary*/
    @GetMapping("/user-topic-vocas-new")
    public ResponseEntity<List<VocabularyTopicEntity>> listVocaTopicNew() {
        List<VocabularyTopicEntity> vocabularyTopicEntities = vocabularyTopicService.getNewTopicVoca();
        return ResponseEntity.ok(vocabularyTopicEntities);
    }
