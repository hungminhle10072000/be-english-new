...
const USER_API_LOGIN = "https://be-english.herokuapp.com/authenticate";
const USER_API_ForgetPassWord = 'https://be-english.herokuapp.com/api/users/check-username-email';
...
class UserService {
    ...
    register(userDto, file) {
        ...
        return axios.post('https://be-english.herokuapp.com/register', formData,{
