        ...
        return (
            <Fragment>
               ...
               <div className='group-select-grammar'>
                    <Select className='class-select-grammar' onChange={(event) => this.hadnleOnChange(event)} options={this.props.userValueSelectGrammar} defaultValue={this.props.userValueSelectGrammar[0]} placeholder='Chọn bài ngữ pháp ...' />
